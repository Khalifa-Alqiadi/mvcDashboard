...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_offers" method="POST">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <label class="form-label">نبة الخصم</label>
        <input name="discount" type="text" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <select name="book_ids" class="form-select">
            <option value="">اختار اسم الكتاب</option>
            <?php
      ...
      <div class="col-md-6">
        <label class="form-label">اختار اسم القسم</label>
      ...
      <div class="col-md-6">
        <div class="row">
            <div class="form-check mb-2">
                <input name="all_books" class="form-check-input" type="radio" />
                <label class="form-check-label">اختيار كل الكتب</label>
            </div>
        </div>
      </div>
      </div>
