  ...
  <form class="card-body" action="/save_publisher" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-4">
      <div class="col-md-6">
        ...
        <input name="pub_name" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الرقم البديل</label>
        <input name="alt_phone" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">رقم الفاكس</label>
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">صورة الناشر</label>
        <div class="input-group input-group-merge">
