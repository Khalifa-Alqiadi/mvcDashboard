  ...
  <form class="card-body" action="/save_book" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6">
        ...
        <div class="input-group input-group-merge">
          <input  name="price" type="text"  class="form-control"  aria-describedby="multicol-email2" />
        </div>
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">وصف الكتاب</label>
        <div class="input-group input-group-merge">
          <input  name="description" type="text"  class="form-control"  aria-describedby="multicol-email2" />
        </div>
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">عدد صفحات الكتاب</label>
        <div class="input-group input-group-merge">
          <input  name="pages_number" type="number"  class="form-control"  aria-describedby="multicol-email2" />
        </div>
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-email"> اسم مؤلف الكتاب</label>
        <div class="input-group input-group-merge">
          <input  name="author_id" type="text"  class="form-control"  aria-describedby="multicol-email2" />
        </div>
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email"> اسم ناشر الكتاب</label>
        <div class="input-group input-group-merge">
          <input  name="publisher_id" type="text"  class="form-control"  aria-describedby="multicol-email2" />
        </div>
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email"> كمية الكتاب</label>
        <div class="input-group input-group-merge">
          <input  name="quantity" type="number"  class="form-control"  aria-describedby="multicol-email2" />
        </div>
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email"> صيغة الكتاب</label>
        <div class="input-group input-group-merge">
